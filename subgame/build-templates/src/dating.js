(function () {
    ...
    function boot() {
        ...
        var onStart = function () {
            ...
            console.log('load scene: ' + launchScene);
...
//            jsList = jsList.concat(['jsb_anysdk.js', 'jsb_anysdk_constants.js']);
    ...
    if (window.jsb) {
        ...
        cocos2d.async = true;
        cocos2d.src = settings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.js';
